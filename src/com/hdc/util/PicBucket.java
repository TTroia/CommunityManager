...
import com.hdc.util.UpYun.PARAMS;
...
public class PicBucket {
	...
	// 运行前先设置好以下三个参数
	/**
	 * 登录账号：cuidanlei2015  dsj8651237
	 */
	private static final String BUCKET_NAME = "comm2";
	private static final String OPERATOR_NAME = "cuidanlei";
	private static final String OPERATOR_PWD = "dsj8651237";
	...
	/** 上传到upyun的图片名 */
	private static final String PIC_NAME = null;

	/** 本地待上传的测试文件 */
	private static final String SAMPLE_PIC_FILE = null;
	 ...
	 * @throws IOException
	 */
	public static String testGmkerl(File file,String path) throws IOException {

		// 要传到upyun后的文件路径
		String filePath = DIR_ROOT + path;
		...
		params.put(PARAMS.KEY_X_GMKERL_VALUE.getValue(), "310x310");
	 ...
	 * @throws IOException
	 */
	public static String testWriteFile(File file,String path) throws IOException {
...
*/
	...
	public static void main(String[] args) {
		File file = new File("E:\\1433907419697.jpg");
		try {
			long s = System.currentTimeMillis();
			String imgUrl=PicBucket.testGmkerl(file,"test.jpg");
