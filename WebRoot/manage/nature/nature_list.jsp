...
<nav class="navbar navbar-default" role="navigation" >
   <div style="margin-top:10px">
      <form class="navbar-form navbar-left" role="search" id="searchform" method="post" action="<c:url value='/nature!_list.action' />">
   ...
   <div style="margin-top:10px;float:right;">
   	<button class="btn btn-add" onclick="show_add_dialog()">添加新性质 »</button>
